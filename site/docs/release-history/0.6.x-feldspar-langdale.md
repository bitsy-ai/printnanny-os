...
* Maintenance: Pin `setuptools==67.7.2` to fix an error seen in new OctoPrint installations, `module 'pkg_resources' has no attribute 'declare_namespace'`[#299](https://github.com/bitsy-ai/printnanny-os/issues/299)